...
LIBDPDK_VERSION="23.11"

rm -rf ${BUILD_DIR}
mkdir ${BUILD_DIR}
apt update
apt install -y build-essential meson ninja-build python3-pyelftools libnuma-dev libelf-dev \
               libarchive-dev gcc-multilib libpcap-dev clang llvm curl m4
