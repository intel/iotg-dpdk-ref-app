...
set_rule()
{
	...
	sudo ethtool -N $IFACE flow-type ether proto 0x0800 queue 3
...
main()
{
	...
	set_rule $IFACE
        ...
        c=1
        while [ $c -lt 3 ]; do
            sudo ./setup/clock-setup.sh $IFACE
